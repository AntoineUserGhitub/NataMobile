package natamobile.natamobile2.GoogleCloud;
...
public class StorageUtil {
    ...
    public static void uploadFile(Activity activity2,String bucketName, String filePath,String contentType)
    {
        activity=activity2;
        try {
            ...
            try {
                ...
                insert.setContentEncoding(contentType);
                insert.execute();
        ...
        try {
            ...
            if (storage == null)
            {
                ...
                Credential credential = new GoogleCredential.Builder()
                        ...
                        .setServiceAccountId("natamobile@rogver-182108.iam.gserviceaccount.com") //Email
    ...
    private static File getTempPkc12File() {
        try {
            ...
            InputStream pkc12Stream = activity.getResources().getAssets().open("StorageKeys/ROGVER-561f06427804.p12");
            File tempPkc12File = File.createTempFile("ROGVER-62f04b8618db", "p12");
